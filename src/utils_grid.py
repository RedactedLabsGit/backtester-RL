...
def geo_price_grid_gen_old(p_min, p_max, price_increment=0.1):
    ...
    nb_price_points = math.floor(math.log(p_max / p_min) / math.log(1 + price_increment)) + 1
...
def brownian_price_series_generator(duration=10, initial_price=2000.0, volatility=1.0, seed=12):
    np.random.seed(seed)
